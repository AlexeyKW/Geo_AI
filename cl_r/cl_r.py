...
class cl_r:
    ...
    def update_fields(self):
        """Update the field combobox based on the selected layer."""
    ...
    def run(self):
        ...
        if self.first_start == True:
            ...
            self.dlg = cl_rDialog()
        # Connect the layer changed signal to the slot
        self.dlg.mMapLayerComboBox.layerChanged.connect(self.update_fields)
        # show the dialog
        self.dlg.show()
